...
const UploadPage = () => {
 ...
 const uploadconfirmbutton = {
  ...
  const handleFileUploadInvoice = () => {
    ...
    axios
      .post("http://localhost:3000/uploadDatainvoice", formData, {
        headers: {
  ...
  const handleFileUploadSOA = () => {
      ...
      axios
        .post("http://localhost:3000/uploadDatasoa", formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
  ...
  return (
    <div>
      ...
      <div style={uploadconfirm}>
          <button style={uploadconfirmbutton} onClick={handleFileUploadInvoice}>Confirm Invoice</button>
          <button style={uploadconfirmbutton} onClick={handleFileUploadSOA}>Confirm SOA</button>
