...
const filepath = 'C:/HuiYi/SUTD/Modules/Term 5/Elements of Software Construction/C2I3-test/telpdf/soa5.pdf';
const dict = {
    headers: ['Invoice ID', 'Issued Date', 'Due Date', 'Amount','Supplier ID'],
    mapping: {
    ...
    'Due Date':'Due Date', 'GST REG NO:':'Supplier ID', 'GST Reg No.:':'Supplier ID', 'GST Reg.No:':'Supplier ID', 'ST Reg. No.':'Supplier ID', 'GST Registration No':'Supplier ID',
