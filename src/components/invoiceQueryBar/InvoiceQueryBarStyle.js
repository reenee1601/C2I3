     ...
     export const searchFilterTextStyle = {
        color: "#3A3A3A",
        fontFamily: "Inter",
        fontSize: "20px",
        fontStyle: "normal",
     ...
     export const allUserInputStyle = {
        display: "flex",
        flexDirection: "row",
     ...
     export const userLongerInputStyle = {
        borderRadius: "5px",
        background: "#FFE8E8",
        border: "none",
        width: "85%",
